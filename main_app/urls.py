...
# Update attendance page (UI only)
...
# SAVE attendance (NEW)
path("staff/attendance/save/", staff_views.save_attendance,
     name='save_attendance'),

# UPDATE attendance (FIXED URL)
path("staff/attendance/update/save/", staff_views.update_attendance,
